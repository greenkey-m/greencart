...
$document->addStyleSheet('components/com_greencart/assets/css/site.css');
$document->addScript('components/com_greencart/assets/js/site.js');

// Require helper files
JLoader::register('GreencartHelper', __DIR__ . '/helpers/greencart.php'); 
JLoader::register('GreencartHelperRoute', __DIR__ . '/helpers/route.php'); 
