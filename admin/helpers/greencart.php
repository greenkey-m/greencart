...
/**
 * Greencart component helper.
 */
abstract class GreencartHelper
{
	/**
	...
	**/
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_greencart/greencart.xml";
	...
	**/
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_greencart');
	...
	**/
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_GREENCART_SUBMENU_DASHBOARD'), 'index.php?option=com_greencart&view=greencart', $submenu === 'greencart');
		if ($user->authorise('look.access', 'com_greencart') && $user->authorise('look.submenu', 'com_greencart'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_GREENCART_SUBMENU_LOOKS'), 'index.php?option=com_greencart&view=looks', $submenu === 'looks');
		}
	}
	 ...
	 */
	public static function xls($rows,$fileName = null,$title = null,$subjectTab = null,$creator = 'Greenkey',$description = null,$category = null,$keywords = null,$modified = null)
	{
		// set the user
		$user = JFactory::getUser();
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'greencart')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'greencart', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__greencart_'.$type.' AS a');
	...
	* 
	**/
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'greencart')
	{
		// get the user object
		$user = JFactory::getUser();
		// load the JObject
	...
	**/
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $component = 'Greencart', $config = array())
	{
		// fix the name
	...
	*/
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_greencart');
		
		$parentId = $parent->id;
		$name     = 'com_greencart.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_greencart', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__greencart_'.$table, $object, 'id');
			}
		}
		return false;
	}
