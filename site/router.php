...
/**
 * Routing class from com_greencart
 *
 * @since  3.3
 */
class GreencartRouter extends JComponentRouterBase
{	
	/**
	 * Build the route for the com_greencart component
	 *
	...
	public function build(&$query)
	{
		...
		if (isset($view) && isset($query['id']) && ($view === 'looks'))
		{
	...
	protected function getVar($table, $where = null, $whereString = null, $what = null, $category = false, $operator = '=', $main = 'greencart')
	{
...
function GreencartBuildRoute(&$query)
{
	$router = new GreencartRouter;
	
	return $router->build($query);
}

function GreencartParseRoute($segments)
{
	$router = new GreencartRouter;
