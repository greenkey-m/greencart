...
class GreencartViewLooks extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$HeaderCheck = new greencartHeaderCheck;
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_greencart/assets/css/looks.css', (GreencartHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	public function escape($var, $sorten = false, $length = 40)
	{
		...
		return GreencartHelper::htmlEscape($var, $this->_charset, $sorten, $length);
	}
}
