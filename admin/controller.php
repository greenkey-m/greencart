...
/**
 * General Controller of Greencart component
 */
class GreencartController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		$view   = $this->input->getCmd('view', 'greencart');
		...
		{
			if ($data['edit'] && $layout == 'edit' && !$this->checkEditId('com_greencart.edit.'.$data['view'], $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_greencart&view='.$data['views'], false));
				}
