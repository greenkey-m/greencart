...
<script type="text/javascript">
	...
	jQuery(window).load(function() {
		jQuery('#greencart_loader').fadeIn('fast');
		jQuery('#loading').hide();
	});
</script>
<div id="greencart_loader" style="display: none;">
<form action="<?php echo JRoute::_('index.php?option=com_greencart&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'lookTab', 'details', JText::_('COM_GREENCART_LOOK_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'lookTab', 'more', JText::_('COM_GREENCART_LOOK_MORE', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'lookTab', 'publishing', JText::_('COM_GREENCART_LOOK_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('look.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('look.publlshing', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'lookTab', 'permissions', JText::_('COM_GREENCART_LOOK_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
